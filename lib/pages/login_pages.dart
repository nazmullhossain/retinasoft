...
class _LoginPagesState extends State<LoginPages> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarWidget(titleName: 'Login',),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFieldWidget(controller:   controller.textEditingController.value,),
                  SizedBox(height: dSize(.01),),
                  OutlinedButton(onPressed: ()async{
                    ...
                    await  apiHelper.sendOtp(context, controller.textEditingController.value.text.trim());
                      Navigator.push(context, MaterialPageRoute(builder: (_)=>OtpPages()));
                  ...
                  }, child: _isLoggingIn?Center(child: CircularProgressIndicator(),): Text("Get OTP"))
